 ...
 */
//定时发送数据
public class SendCodeTimerTest extends TimerTask {
    ...
    private long time = 0;
    public SendCodeTimerTest(SerialPort serialPort, List<CodeProperties> codePropertieslist) {
        this.codePropertieslist = codePropertieslist;
        this.serialPort = serialPort;
    }

    public SendCodeTimerTest() {
    }

    public SendCodeTimerTest(SerialPort serialPort, List<CodeProperties> codePropertieslist, int everySendTime) {
        this.codePropertieslist = codePropertieslist;
        this.serialPort = serialPort;
